      ...
      <div className="footer__container container">
        <div className="footer__row">
          <div className="footer__col">
            ...
            <div className="footer__soc1als-2 soc1als-2">
              <ul className="soc1als-2__list">
                <li className="soc1als-2__item">
                  <a
                    className="soc1als-2__link"
                    href="/"
                    target="_blank"
                    aria-label="facebook"
                    title="facebook"
                ...
                <div className="nav-footer__col">
                  <ul className="nav-footer__list">
                    <li className="nav-footer__item">
                      <a href="#home" className="nav-footer__link">
                        Home
                      </a>
                    </li>
                    <li className="nav-footer__item">
                      <a href="#episodes" className="nav-footer__link">
                        Episodes
                      </a>
                    </li>
                    <li className="nav-footer__item">
                      <a href="#about" className="nav-footer__link">
                        About
                      </a>
                    </li>
                    <li className="nav-footer__item">
                    ...
                    <li className="nav-footer__item">
                      <a href="#contact" className="nav-footer__link">
                        Contact
                      </a>
                    </li>
                  </ul>
          ...
          <div className="footer__col">
            <div className="footer__soc1als-1 soc1als-1">
                  ...
                  >
                    ...
                    >
                      ...
                      <defs>
                        ...
                        >
                          <stop offset={0} stopColor="#FF7602" />
