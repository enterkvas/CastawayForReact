...
export default function Footer () {
  return (
    <footer className={styles.footer} id="contact">
      <div className={clsx(styles.footerContainer, styles.container)}>
        <div className={styles.row}>
          <div className={styles.col}>
            <Logo />
            <div className={clsx(styles.footerSoc1als2, styles.soc1als2)}>
              <ul className={styles.soc1als2List}>
                <li className={styles.soc1als2Item}>
                  <a
                    className={styles.soc1als2Link}
                    href="/"
                    target="_blank"
                    aria-label="facebook"
                    title="facebook"
              ...
              <div className={styles.navRow}>
                ...
                <div className={styles.navCol}>
                  <ul className={styles.list}>
                    <li className={styles.item}>
                      <a
                        href="./addPages/style-guide.html"
